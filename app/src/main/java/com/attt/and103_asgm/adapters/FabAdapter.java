package com.attt.and103_asgm.adapters;
...
import com.attt.and103_asgm.databinding.ItemMyFabHomeBinding;
...
public class FabAdapter extends RecyclerView.Adapter<FabAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public FabAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemMyFabHomeBinding binding = ItemMyFabHomeBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
        return new ViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull FabAdapter.ViewHolder holder, int position) {
